...
- **Emergency Triage of Brain Computed Tomography via Anomaly Detection with a Deep Generative Model**, ***Nature Communications***, Cited by **5**. 
...
- **Deep learning on radar centric 3D object detection**, **ArXiv**, Cited by **20**.
